...
class ChatRoomsView<P extends ChatRoomsViewProps = ChatRoomsViewProps> extends ObjectsListView<P> {
  ...
  getColumns<CC extends ChatRoomsConnectionChatRoomFragment>(): ColumnConfig<CC>[] {
...
export default withStyles(styles)((props: ChatRoomsViewProps) => <ChatRoomsView {...props} />);
