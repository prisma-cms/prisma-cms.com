...
class BlogsView<P extends BlogsViewProps = BlogsViewProps> extends ObjectsListView<P> {
...
export default withStyles(styles)((props: BlogsViewProps) => <BlogsView {...props} />);
